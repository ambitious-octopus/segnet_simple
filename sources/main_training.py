import torch
import torch.utils.data as tutd
...
def main(
    ...
    # Initialize model
    model_deeplabv3, input_size = initialize_model(
        num_classes, keep_feature_extract, use_pretrained=True
    )
    ...
    # Train and evaluate
    model_deeplabv3_state_dict, hist = train_model(
        model_deeplabv3,
        num_classes,
        dataloaders_dict,
        criterion,
    ...
    print("Save ...")
    torch.save(
        model_deeplabv3_state_dict,
        os.path.join(dest_dir, "best_DeepLabV3_Skydiver.pth"),
    )
