...
def initialize_model(num_classes, keep_feature_extract=False, use_pretrained=True):
    ...
    model_deeplabv3 = models.segmentation.deeplabv3_resnet101(
        pretrained=use_pretrained, progress=True
    )
    ...
    input_size = 224
    model_deeplabv3.classifier = torchvision.models.segmentation.deeplabv3.DeepLabHead(
        2048, num_classes
    )
    model_deeplabv3.load_state_dict(torch.load("train.pth"))
